...
class EventController extends Controller
{
    public function index(Request $request)
    {
        ...
        $events = $query->get(); // Use the query to fetch events
        $eventData = [];
        ...
        return view('full_calendar', compact('events', 'eventData', 'appointments'));
    }
    ...
    public function ajax(Request $request)
    {
        ...
        switch ($request->type) {
            case 'add':
                ...
                $event->appointment_id = $appointmentId; // Use the generated appointment ID
            ...
            case 'update':
                ...
                if ($event) {
                    $event->appointment_date = $request->start; // Assuming `start` is the new date
                    $event->save();
